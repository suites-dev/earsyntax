...
- Crashes that were introduced in 5.9 or 6.0 that _also_ repro in 7.0 _and_ have a portable fix _and_ don't incur other behavioral changes
- Security issues
- Language service crashes that substantially impact mainline usage
- Serious regressions from 5.9 (these must _seriously_ impact a _large_ proportion of users)
